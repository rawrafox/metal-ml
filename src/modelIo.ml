...
module Implementation = struct
  module Extern = struct
    ...
    let mdl_asset_object_at_index = ObjC.message_send "objectAtIndex:" (nsu_integer @-> returning ObjC.id)
    let mdl_asset_object_at_indexed_subscript = ObjC.message_send "objectAtIndexedSubscript:" (nsu_integer @-> returning ObjC.id)
  ...
  class mdl_named (ptr: ObjC.id) = object (self)
    ...
    method object_at_index index = new mdl_object (mdl_asset_object_at_index ptr index)
    method object_at_indexed_subscript index = new mdl_object (mdl_asset_object_at_indexed_subscript ptr index)
